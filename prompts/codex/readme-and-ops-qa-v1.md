...
현재 봇에는 참여자 기능, 운영자 기능, 리디파인 포인트 시스템, 교환, 체크인, 미션, 인증, 운영 현황, 상점/미션 관리, 운영 데이터 내보내기 기능까지 구현되어 있다.
...
* 리디파인 참여자 안내, FAQ, 온보딩, 리디파인 포인트, 상점, 교환, 체크인, 미션, 인증, 운영자 관리 기능을 제공한다고 설명한다.
* MEE6는 포인트, EXP, 레벨업 운영에 사용하지 않고, 리디파인 봇이 실제 운영 기능과 리디파인 포인트를 담당한다고 정리한다.
