...
프로젝트 리디파인 운영용 디스코드 봇 — 참여자 안내·FAQ/지식 검색·여정 포인트·미션 승인·상점/교환·운영 콘솔(`/admin`)·미니게임·DM 챗. 로컬 JSON 상태의 MVP, Railway 배포 대상. **핵심 기능은 운영 투입 가능 수준으로 완성**(PR #85까지), 현재는 실운영 준비·고도화 단계다.
