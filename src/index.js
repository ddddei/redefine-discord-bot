  ...
  if (subcommand === '규칙') {
    const embed = createGuideEmbed(
      ...
      [
        ...
        '4. 과한 친목, 반복 DM, 사적인 접근은 상대에게 부담이 될 수 있어 조심해 주세요.',
        '5. 건의나 불편사항은 공개 채팅방에서 길게 논쟁하기보다 운영진에게 알려 주세요.',
        '6. 각 채널의 성격에 맞게 대화해 주세요.',
        '7. 혐오, 차별, 성적 콘텐츠, 폭력적 표현, 사칭, 광고, 스팸, 금전 거래, 불법 링크 공유는 제한되거나 운영진 조치가 있을 수 있어요.',
        '8. 참여 중단이나 탈퇴를 고민할 때는 공개 채팅방에 자세히 남기기보다 운영진에게 먼저 알려 주세요.',
        '9. 처음부터 활발히 참여하지 않아도 괜찮아요. 읽기, 이모지 반응, 짧은 질문도 모두 참여의 방식이에요.',
        '',
        '어렵거나 불편한 일이 생기면 혼자 해결하려고 애쓰지 않아도 괜찮아요. 운영진에게 편하게 알려 주세요.',
      ].join('\n')
    );
