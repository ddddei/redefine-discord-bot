...
const SESSION_01_BLACK_BELL = {
  ...
  choices: {
    pursue: {
      ...
      outcomes: {
        strong: '토른과 함께 문을 박차고 나가 고블린을 따라잡습니다. 뿌리가 굵게 드러난 비탈에서 고블린이 표식을 놓치고 달아납니다. 지도 조각은 흠 없이 되찾았고, 고블린이 떨어뜨린 숲길 표식까지 손에 넣었습니다. 표식에는 흙 속으로 파고든 뿌리 무늬가 또렷하게 새겨져 있어, 다음에 그 무늬를 따라가면 곧장 길을 찾을 수 있을 것 같습니다.',
        mixed: '토른과 함께 쫓았지만 고블린은 마지막 순간 몸을 던져 빠져나갑니다. 몸싸움 중 지도 조각 한 귀퉁이가 찢어지고, 토른의 방패에도 긁힌 흔적이 남습니다. 숲길 표식은 손에 들어왔지만, 거기 새겨진 뿌리 무늬 절반이 흐릿합니다. 서두른 흔적이 다음 길에도 따라붙을 것 같습니다.',
        weak: '고블린은 지도 조각 일부를 찢어 쥔 채 어둠 속으로 사라집니다. 토른이 횃불을 들어 살펴보니 바닥에는 어렴풋한 표식만 남았습니다. 지금 바로 쫓는다면 뿌리 무늬도 제대로 읽지 못한 채 아무 준비 없이 숲길에 들어서야 할 것 같습니다.',
      },
    },
    investigate: {
      id: 'investigate',
      ...
      approachLabel: '살펴보기',
      outcomes: {
        strong: '마라와 토른에게 차분히 묻고, 우물가에서 검은 종소리가 남긴 그을린 탑 표식까지 확인합니다. 토른은 표식을 보더니 "이건 안개 탑 쪽 길에서만 나는 그을음이오"라고 짚어 줍니다. 지도 조각은 안전하게 보호했고, 마라의 보급품과 토른의 낡은 방패까지 챙겼습니다. 안개 탑으로 이어진 뿌리 길의 방향을 미리 알아둔 셈입니다.',
        mixed: '단서는 찾았지만 시간이 꽤 걸렸습니다. 마라의 보급을 받으려면 작은 부탁을 들어줘야 할 것 같습니다. 토른은 그을린 표식을 발견했지만 "방향은 알겠는데, 고블린은 이미 멀리 달아난 뒤요"라며 아쉬워합니다.',
        weak: '마을을 살피는 동안 고블린은 완전히 사라졌습니다. 지도 조각은 지켰지만, 우물가의 표식은 빗물에 거의 씻겨 나가 토른도 방향을 가늠하기 어려워합니다.',
      },
    },
    negotiate: {
      id: 'negotiate',
      ...
      approachLabel: '말로 풀기',
      outcomes: {
        strong: '렌은 망설이다 지도의 출처를 알려주고, 숲길 표식의 위치까지 순순히 짚어줍니다. "그 지도, 원래는 뿌리 아래로 이어진 길을 그린 거요." 다음 숲길 판정에 분명한 이점을 만들었습니다.',
        mixed: '렌은 거래에 응하지만 대가를 요구합니다. 지도의 출처가 안개 탑 아래 뿌리 길이라는 단서를 얻은 대신, 렌에게 작은 빚을 지게 되었습니다.',
        weak: '렌은 지도의 출처를 먼저 숨기고 더 큰 거래를 요구합니다. 토른이 옆에서 눈치를 주지만, 협상은 다음으로 미뤄야 할 것 같습니다.',
      },
    },
  },
};
